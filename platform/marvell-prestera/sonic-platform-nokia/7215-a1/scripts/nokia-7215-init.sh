...
load_kernel_drivers() {
    ...
    sudo insmod /lib/modules/6.12.30-sonic-arm64/kernel/extra/nokia_7215_ixs_a1_cpld.ko
    sudo insmod /lib/modules/6.12.30-sonic-arm64/kernel/extra/cn9130_cpu_thermal_sensor.ko
}
