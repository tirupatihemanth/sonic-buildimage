...
SLK_KCONFIG = "src/sonic-linux-kernel/config.local/featureset-sonic/config"
SLK_KCONFIG_AMD64 = "src/sonic-linux-kernel/config.local/amd64/config.sonic"
SLK_KCONFIG_ARM64 = "src/sonic-linux-kernel/config.local/arm64/config.sonic-mellanox" 
