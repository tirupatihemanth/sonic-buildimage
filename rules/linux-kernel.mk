...
KVERSION = $(KERNEL_VERSION)-$(KERNEL_FEATURESET)-armmp
endif
...
export KVERSION KERNEL_VERSION KERNEL_SUBVERSION
export EXTERNAL_KERNEL_PATCH_URL
export INCLUDE_EXTERNAL_PATCHES
export EXTERNAL_KERNEL_PATCH_LOC

LINUX_HEADERS_COMMON = linux-headers-$(KERNEL_VERSION)-common-$(KERNEL_FEATURESET)_$(KERNEL_VERSION)-$(KERNEL_SUBVERSION)_all.deb
